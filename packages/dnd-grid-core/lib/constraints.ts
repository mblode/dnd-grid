import { calcGridColWidth, calcGridItemWHPx, clamp } from "./calculate-utils";
import type {
  ConstraintContext,
  LayoutConstraint,
  LayoutItem,
...
export const getDefaultConstraints = <TData>(): LayoutConstraint<TData>[] =>
  defaultConstraints;
...
export const applySizeConstraints = <TData>(
  constraints: LayoutConstraint<TData>[],
  item: LayoutItem<TData>,
  w: number,
  h: number,
