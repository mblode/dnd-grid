...
<div className="not-prose my-6 rounded-lg border border-zinc-200/70 bg-white/70 shadow-sm dark:border-white/10 dark:bg-white/5">
  <iframe
    ...
    src="https://blode.co/dnd-grid/examples/dynamic-add-remove-example?embed=1"
...
```bash
npx shadcn@latest add https://blode.co/dnd-grid/r/dynamic-add-remove-example.json
```
