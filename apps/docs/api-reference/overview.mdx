...
|-----------|-------------|
| [`DndGrid`](dnd-grid) | Main grid layout component |
| [`ResponsiveDndGrid`](responsive-dnd-grid) | Breakpoint-aware responsive grid |
...
| Type | Description |
|------|-------------|
| [`Layout`](layout-item#layout) | Array of layout items (`LayoutItem[]`) |
| [`LayoutItem`](layout-item) | Position and size of a single grid item |
