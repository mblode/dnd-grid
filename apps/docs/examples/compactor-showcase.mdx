...
<iframe
  src="https://dnd-grid.com/examples/compactor-showcase?embed=true"
  width="100%"
  height="520"
  style={{ border: "1px solid #e5e7eb", borderRadius: "8px", marginBottom: "24px" }}
/>

[View source on GitHub](https://github.com/mblode/dnd-grid/blob/main/apps/web/app/examples/compactor-showcase/page.tsx)
