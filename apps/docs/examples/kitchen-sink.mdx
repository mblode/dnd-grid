...
<iframe
  src="https://dnd-grid.com/examples/kitchen-sink?embed=true"
  width="100%"
  height="760"
  style={{ border: "1px solid #e5e7eb", borderRadius: "8px", marginBottom: "24px" }}
/>

[View source on GitHub](https://github.com/mblode/dnd-grid/blob/main/apps/web/app/examples/kitchen-sink/page.tsx)
...
const PaletteDraggable = ({ item, isActive, onClick }: PaletteDraggableProps) => {
...
export default function KitchenSinkExample() {
  ...
  const [dndRect, setDndRect] = useState<{
    top: number;
    right: number;
    bottom: number;
    left: number;
  ...
  const resetDndState = (clearDragItem = true) => {
  ...
  const handleDndDragStart = useCallback((event: DragStartEvent) => {
    const active = event.active.data.current?.palette as PaletteItem | undefined;
    if (!active) return;
            ...
            {items.map((item) => {
              ...
              return (
                <div
                  ...
                  style={{
                    height: "100%",
                    border: isSelected ? "2px solid #0f9d78" : "1px solid #e5e7eb",
                    borderRadius: 8,
                    padding: 10,
                    fontSize: 12,
                    background: "#fff",
                ...
                >
                  {isHovered && (
                    ...
                    >
                      ...
                      <button type="button" onClick={() => handleDuplicate(item.i)}>
                        Duplicate
                      </button>
                      <button type="button" onClick={() => handleDelete(item.i)}>
                        Delete
                      </button>
                    </div>
                  )}
